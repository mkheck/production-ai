...
link:https://speakerdeck.com/mkheck/paving-a-painless-path-to-production-ai-in-your-java-applications[Paving a Painless Path to Production AI in your Java Applications]
